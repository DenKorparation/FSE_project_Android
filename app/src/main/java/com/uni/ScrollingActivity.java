...
public class ScrollingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        cityEdt = findViewById(R.id.idLLEdtCity);
        ...
        locationManager = (LocationManager) getSystemService(Context.LOCATION_SERVICE);
         ...
         searchIV.setOnClickListener(new View.OnClickListener() {
             ...
             public void onClick(View v) {
                 ...
                 if(city.isEmpty()){
                     Toast.makeText(ScrollingActivity.this,"Пожалуйста, введите имя города",Toast.LENGTH_SHORT).show();
                 }else{
    ...
    /*private void  getWeatherInfo(String cityName){
        String url = "http://api.weatherapi.com/v1/forecast.json?key=629ebe7c94bc408d8d3110656210111&q="+cityName+"&days=1&aqi=yes&alerts=yes";
        cityNameTV.setText(cityName);
        ReferenceQueue requestQueue = Volley.newRequestQueue(ScrollingActivity.this);
         jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError volleyError) {
                Toast.makeText(ScrollingActivity.this,"enter valid name",Toast.LENGTH_SHORT).show();
            }
        });
